...
export default function Quote() {
  return (
    <section className='bg-white flex flex-col mx-auto max-w-2xl px-6 py-24 sm:py-32 lg:px-8'>
      <figure className='mx-auto max-w-2xl px-5'>
        ...
        <blockquote className='mt-10 text-xl font-semibold leading-8 tracking-tight text-accent sm:text-2xl sm:leading-9'>
          <p>
